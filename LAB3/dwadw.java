...
//     private static Deque<Queue<Integer>> listGedung = new ArrayDeque<>();
...
//         Queue<Integer> temp = listGedung.pollFirst();
//         for (int i = 0; i < Si; i++) {
...
//         }
//         if (kanan) {
//             if (!temp.isEmpty()) listGedung.addLast(temp);
//         } else {
//             if (!temp.isEmpty()) listGedung.addFirst(temp);
//             Queue<Integer> temp2 = listGedung.pollLast();
//             listGedung.addFirst(temp2);
//         }
